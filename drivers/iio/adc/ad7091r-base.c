...
const struct regmap_access_table ad7091r2_readable_regs_table = {
	.yes_ranges = ad7091r2_readable_ranges,
	.n_yes_ranges = ARRAY_SIZE(ad7091r2_readable_ranges),
};
EXPORT_SYMBOL_GPL(ad7091r2_readable_regs_table);

const struct regmap_access_table ad7091r4_readable_regs_table = {
	.yes_ranges = ad7091r4_readable_ranges,
	.n_yes_ranges = ARRAY_SIZE(ad7091r4_readable_ranges),
};
EXPORT_SYMBOL_GPL(ad7091r4_readable_regs_table);

const struct regmap_access_table ad7091r8_readable_regs_table = {
	.yes_ranges = ad7091r8_readable_ranges,
	.n_yes_ranges = ARRAY_SIZE(ad7091r8_readable_ranges),
};
EXPORT_SYMBOL_GPL(ad7091r8_readable_regs_table);
...
const struct regmap_access_table ad7091r2_writable_regs_table = {
	.yes_ranges = ad7091r2_writable_ranges,
	.n_yes_ranges = ARRAY_SIZE(ad7091r2_writable_ranges),
};
EXPORT_SYMBOL_GPL(ad7091r2_writable_regs_table);

const struct regmap_access_table ad7091r4_writable_regs_table = {
	.yes_ranges = ad7091r4_writable_ranges,
	.n_yes_ranges = ARRAY_SIZE(ad7091r4_writable_ranges),
};
EXPORT_SYMBOL_GPL(ad7091r4_writable_regs_table);

const struct regmap_access_table ad7091r8_writable_regs_table = {
	.yes_ranges = ad7091r8_writable_ranges,
	.n_yes_ranges = ARRAY_SIZE(ad7091r8_writable_ranges),
};
EXPORT_SYMBOL_GPL(ad7091r8_writable_regs_table);
